...
BEGIN_MESSAGE_MAP(CReportCtrl, CListCtrl)
	...
	ON_WM_RBUTTONDOWN()
	ON_COMMAND(ID_BATCH_CONVERT,OnBatchConvert)
	ON_WM_DESTROY()
	ON_WM_LBUTTONUP()
...
{
	// TODO: Add your message handler code here and/or call default
// 	if (CSearchDlg::m_eventType.IsItemChecked(12) != false)
// 	{
// 		CSearchDlg::m_eventType.CheckAllItems();
// 	}else{
...
void CReportCtrl::OnItemEventTypeClk(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CReportCtrl::OnBatchConvert()
{
//	CBatchConvertDlg dlg;
	...
	CToolBarDlg::m_BatchDlg.m_1stFilePath = CToolBarDlg::m_1stFilePath;
	CToolBarDlg::m_BatchDlg.m_2ndFilePath = CToolBarDlg::m_2ndFilePath;
	memset(&CToolBarDlg::m_BatchDlg.m_systemTime, 0, sizeof(SYSTEMTIME));
	CToolBarDlg::m_BatchDlg.m_systemTime.wYear = CToolBarDlg::m_DateTime.year;
	CToolBarDlg::m_BatchDlg.m_systemTime.wMonth = CToolBarDlg::m_DateTime.month;
	CToolBarDlg::m_BatchDlg.m_systemTime.wDay = CToolBarDlg::m_DateTime.day;
	CToolBarDlg::m_BatchDlg.m_systemTime.wHour = (WORD)CToolBarDlg::m_DateTime.hour;
	CToolBarDlg::m_BatchDlg.m_systemTime.wMinute = (WORD)CToolBarDlg::m_DateTime.minute;
