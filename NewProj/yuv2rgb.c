...
*/
void yuv2rgb_32(unsigned char *puc_y, int stride_y, 
...
void yuv2rgb_24(unsigned char *puc_y, int stride_y, 
                unsigned char *puc_u, unsigned char *puc_v, int stride_uv, 
                unsigned char *puc_out, int width_y, int height_y,
								unsigned int _stride_out) {
...
void yuv2rgb_555(unsigned char *puc_y, int stride_y, 
                 unsigned char *puc_u, unsigned char *puc_v, int stride_uv, 
                 unsigned char *puc_out,	int width_y, int height_y,
				 unsigned int _stride_out) 
{
...
void yuv2rgb_565(unsigned char *puc_y, int stride_y, 
                unsigned char *puc_u, unsigned char *puc_v, int stride_uv, 
                unsigned char *puc_out, int width_y, int height_y,
								unsigned int _stride_out) 
{
...
{ 
	...
	for (y=height_y/2; y; y--) {
		register unsigned char *py, *py2, *pu, *pv;
		register int x;
		unsigned int  tmp;
		...
		for (x=width_y/2; x; x--) {
			...
			tmp |= *(py++) << 16;
			tmp |= *(pv++) << 24;
			*(unsigned int *)puc_out=tmp;
			puc_out += 4;

			tmp &= 0xFF00FF00;
			tmp |= *(py2++);
			tmp |= *(py2++) << 16;
			*(unsigned int *)puc_out2=tmp;
			puc_out2 += 4;
		}
