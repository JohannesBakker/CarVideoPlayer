...
//
class CBitmapSliderMemDC : public CDC {
private:	
...
public:
	...
	CBitmapSliderMemDC(CDC* pDC, const CRect* pRect = NULL, BOOL bBg = FALSE) : CDC()
	{
		ASSERT(pDC != NULL); 
	...
	CBitmapSliderMemDC* operator->() 
	{
		return this;
	}	

	// Allow usage as a pointer	
	operator CBitmapSliderMemDC*() 
	{
		return this;
	}
};
