...
public:
	...
	void DrawGraph(MainBinaryData* pData,DWORD curPos,DWORD dura,DWORD nBinSize,DWORD totalSize,bool bSeek, DWORD dwFirstDTS, DWORD currDTS, unsigned char alarmFlag);
	void DrawAccelSpeedGraph(MainBinaryData* , DWORD  , DWORD, DWORD );
	void DrawSpeedGraph(MainBinaryData* , DWORD  , DWORD , DWORD, bool);
	void DrawAlarmGraph(DWORD dwFirstDTS, DWORD currDTS, MainBinaryData* pData, unsigned char alarmFlag);
