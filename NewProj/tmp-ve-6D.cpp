...
int C264Spliter::GetDatas1()
{
	...
	{
		memcpy(m_pY, g_Output.ptr_uChY, 0x5AC00);
		memcpy(m_pU, g_Output.ptr_uChU, 0x16B00);
		memcpy(m_pV, g_Output.ptr_uChV, 0x16B00);
...
int C264Spliter::GetDatas2()
{
	...
	{
		memcpy(m_pY2, g_Output2.ptr_uChY, 0x5AC00);
		memcpy(m_pU2, g_Output2.ptr_uChU, 0x1B600);
		memcpy(m_pV2, g_Output2.ptr_uChV, 0x1B600);
