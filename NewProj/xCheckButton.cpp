// CxCheckButton.cpp : implementation file
/** 12/05/2001 v1.00
...
/////////////////////////////////////////////////////////////////////
long CxDib::WriteBMP(LPWSTR bmpFileName)
{                         
...
/////////////////////////////////////////////////////////////////////////////
// CxCheckButton
CxCheckButton::CxCheckButton()
{
	m_Border=1;				//draw 3D border
	m_FocusRectMargin=0;	//focus dotted rect margin
...
/////////////////////////////////////////////////////////////////////////////
BEGIN_MESSAGE_MAP(CxCheckButton, CButton)
	//{{AFX_MSG_MAP(CxCheckButton)
	ON_WM_ERASEBKGND()
	ON_WM_LBUTTONDOWN()
	ON_WM_LBUTTONUP()
	ON_WM_MOUSEMOVE()
...
END_MESSAGE_MAP()
/////////////////////////////////////////////////////////////////////////////
// CxCheckButton message handlers
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::PreSubclassWindow() 
{
...
/////////////////////////////////////////////////////////////////////////////
BOOL CxCheckButton::OnEraseBkgnd(CDC* pDC) 
{ return 1; }	// doesn't erase the button background
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct) 
{
	...
	RECT tr={r.left+m_FocusRectMargin,r.top,r.right-m_FocusRectMargin,r.bottom};
...
//GSI
		pDC->SetTextColor(RGB(255,255,255)/*m_TextColor*/);
		pDC->FillSolidRect(16,0,tr.right,tr.bottom,RGB(47,56,66));
		pDC->DrawText(sCaption,&tr,m_TextAlign);
	}
...
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::SetShade(UINT shadeID,BYTE granularity,BYTE highlight,BYTE coloring,COLORREF color)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::SetIcon(UINT nIcon, UINT nIconAlign, UINT nIconDown, UINT nIconHighLight)
{
	if (m_IconDown!=m_Icon && m_IconDown) DestroyIcon(m_IconDown);
	if (m_IconHighLight!=m_Icon && m_IconHighLight) DestroyIcon(m_IconHighLight);
	if (m_Icon) DestroyIcon(m_Icon);
...
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::SetTextAlign(UINT nTextAlign)
{
//	see DrawText() styles...
	switch (nTextAlign){
	case BS_RIGHT:
...
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::SetFlat(bool bFlag)
{ m_flat=bFlag; }	//set flat border mode
/////////////////////////////////////////////////////////////////////////////
COLORREF CxCheckButton::SetTextColor(COLORREF new_color)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::SetToolTipText(CString s, CString sDown)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::RelayEvent(UINT message, WPARAM wParam, LPARAM lParam)
{
...
//---------------------------------------------------------
void CxCheckButton::OnLButtonDblClk(UINT flags, CPoint point) 
{
...
//---------------------------------------------------------
void CxCheckButton::OnLButtonDown(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: down\n", ::GetTickCount());
...
//---------------------------------------------------------
void CxCheckButton::OnLButtonUp(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: up\n", ::GetTickCount());
...
//---------------------------------------------------------
void CxCheckButton::OnMouseMove(UINT nFlags, CPoint point)
{
    //TRACE("* %08X: Mouse\n", ::GetTickCount());
...
//---------------------------------------------------------
LRESULT CxCheckButton::OnMouseLeave(WPARAM, LPARAM)
{
    ASSERT (m_tracking);
    //TRACE("* Mouse leave\n");
    m_tracking = false;
...
//    presses TAB key.
//---------------------------------------------------------
void CxCheckButton::OnKillFocus(CWnd *new_wnd)
{
...
//---------------------------------------------------------
LRESULT CxCheckButton::OnRadioInfo(WPARAM wparam, LPARAM)
{
...
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags) 
{
...
//---------------------------------------------------------
LRESULT CxCheckButton::OnBMSetCheck(WPARAM wparam, LPARAM)
{
	m_Checked=wparam!=0;
	switch (m_Style)
	{
...
/////////////////////////////////////////////////////////////////////////////
LRESULT CxCheckButton::OnBMGetCheck(WPARAM wparam, LPARAM)
{ return m_Checked; }	//returns the state for check & radio buttons
/////////////////////////////////////////////////////////////////////////////
void CxCheckButton::SetButtonStyle(UINT nStyle, BOOL bRedraw)
{
...
/////////////////////////////////////////////////////////////////////////////
bool CxCheckButton::SetFont(CString sFontName,long lSize, long lWeight, BYTE bItalic, BYTE bUnderline)
{
	if (m_pLF==NULL) m_pLF=(LOGFONT*)calloc(1,sizeof(LOGFONT));
	if (m_pLF){
		wcsncpy(m_pLF->lfFaceName,sFontName,31);
...
/////////////////////////////////////////////////////////////////////////////
bool CxCheckButton::SetFont(LOGFONT* pNewStyle)
{
	if (pNewStyle){
		if (m_pLF==NULL) m_pLF=(LOGFONT*)calloc(1,sizeof(LOGFONT));
		if (m_pLF){
...
void CxCheckButton::FormatW(LPCWSTR szFmt, ...)
{
	ULONG	bytesWriten;
	WCHAR	szBuffer[2048];
	va_list args;
	...
	va_start(args, szFmt);
	bytesWriten = vswprintf(szBuffer, szFmt, args);
	CString m_strText;
	m_strText = szBuffer;
	SetWindowTextW(/*this->GetSafeHwnd(), */szBuffer);
	va_end(args);
	
	Invalidate();
}

void CxCheckButton::SetChecked(bool bChecked)
{
	SetCheck(bChecked);
}
/////////////////////////////////////////////////////////////////////////////
LOGFONT* CxCheckButton::GetFont()
{ return m_pLF; }
/////////////////////////////////////////////////////////////////////////////
//EOF
