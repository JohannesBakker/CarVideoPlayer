...
{
private:
	void*	m_discFormatData;		//00 IDiscFormat2Data
	SAFEARRAY*			m_mediaTypesArray;		//0c
	HRESULT				m_hResult;				//10
	CString				m_errorMessage;			//14
	HWND				m_hNotificationWnd;		//18
	bool				m_closeMedia;
...
public:
	...
	inline	void* GetInterface() {return m_discFormatData;}//IDiscFormat2Data
